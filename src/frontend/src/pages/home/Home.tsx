...
export function Home() {
  ...
  // const viewportContext = React.createContext<ViewPort>(null!);  // Không truyền vào null được vì nếu null thì useContext ở line 55 null -> bug :D
  ...
  // );
  // const MyComponent = () => {
  //   const { width } = useViewport();      // Tại sao chỗ này bị lỗi hook ?
